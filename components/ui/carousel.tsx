  ...
  return (
    <div className="">
      ...
      <div className="flex mx-auto max-w-80 justify-between items-center gap-3 mt-7">
        ...
        >
          <div
            className="bg-[#F0660A] absolute w-full top-0 bottom-0 -left-full animate-[autoplay-progress_linear_1] [animation-play-state:running]"
            ref={progressNode}
            style={{
        ...
        <Button size={'icon'} variant={"secondary"} onClick={toggleAutoplay} type="button">
          {autoplayIsPlaying ? (
            <Pause fill="currentColor" className="text-[#F0660A]" />
          ) : (
            <Play fill="currentColor" className="text-[#F0660A]" />
          )}
        </Button>
      </div>
    </div>
